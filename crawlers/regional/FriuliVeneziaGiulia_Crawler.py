...
class FriuliVeneziaGiuliaCrawler(BaseCrawler):
    """
    Crawler for Regione Friuli Venezia Giulia grants.
    """
    
    def __init__(self, max_pages: int = 10, delay: float = 1.0):
        """
        Initialize the Friuli Venezia Giulia crawler.
        ...
        self.logger = logging.getLogger("FriuliVeneziaGiuliaCrawler")
    
    def get_grant_listing_urls(self) -> List[str]:
        """
        Get URLs for individual grant listings from Regione Friuli Venezia Giulia.
        
        Returns:
            List[str]: List of URLs to individual grant pages
        """
        # Friuli Venezia Giulia likely has a main bandi page
        grants_url = "/bandi-e-finanziamenti"  # Adjust based on actual site structure
        ...
        grant_items = soup.select(".item-bando")  # Adjust based on site structure
    ...
    def parse_grant_details(self, url: str) -> Dict[str, Any]:
        """
        Parse the details of a grant from Regione Friuli Venezia Giulia.
        ...
        grant_data = {
            ...
            "Località_MR": "Friuli Venezia Giulia",
        ...
        # Extract grant type
        type_element = soup.select_one(".tipo-procedura")  # Adjust selector
        if type_element:
    ...
    def _get_full_grant_text(self, soup: BeautifulSoup) -> str:
        ...
        # Get any additional grant information sections
        info_sections = soup.select(".sezione-bando")  # Adjust selector
