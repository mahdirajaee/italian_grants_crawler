...
class SiciliaCrawler(BaseCrawler):
    """
    Crawler for Regione Sicilia grants.
    """
    
    def __init__(self, max_pages: int = 10, delay: float = 1.0):
        """
        Initialize the Sicilia crawler.
        ...
        self.logger = logging.getLogger("SiciliaCrawler")
    
    def get_grant_listing_urls(self) -> List[str]:
        """
        Get URLs for individual grant listings from Regione Sicilia.
        
        Returns:
            List[str]: List of URLs to individual grant pages
        """
        # Sicilia likely has a bandi page
    ...
    def parse_grant_details(self, url: str) -> Dict[str, Any]:
        """
        Parse the details of a grant from Regione Sicilia.
